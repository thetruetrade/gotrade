...
func NewVarWithSrcLen(sourceLength int, timePeriod int, selectData gotrade.DataSelectionFunc) (indicator *Var, err error) {
...
func NewDefaultVarWithSrcLen(sourceLength int) (indicator *Var, err error) {
